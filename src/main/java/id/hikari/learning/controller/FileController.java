...
import id.hikari.learning.payload.UploadFileResponse;
import id.hikari.learning.repository.ModuleRepository;
import id.hikari.learning.service.FileStorageService;
...
public class FileController {
    ...
    public UploadFileResponse uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        moduleRepository.save(Module.builder()
                ...
                .moduleName("Module_" + new Date())
                .link(fileDownloadUri)
                .build());
